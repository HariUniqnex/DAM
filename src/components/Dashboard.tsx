    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-100">
          ...
          <p className="text-sm text-slate-500 mt-2">
            Different processing types used
          </p>
        </div>
      </div>
        ...
        {sortedOperations.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-slate-500">
              No operations yet. Start by uploading and processing images.
            </p>
          </div>
        ) : (
        ...
        {stats.recentOperations.length === 0 ? (
          ...
          <div className="space-y-3">
            {stats.recentOperations.map((operation) => {
              ...
              const Icon =
                OPERATION_ICONS[operation.operationType] || FileImage;
              const label =
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span
                      className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-full text-xs font-medium border ${getStatusColor(
                        operation.status
                      )}`}
                    >
                      <StatusIcon
