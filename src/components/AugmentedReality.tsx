...
import {
  Smartphone, Tablet, Download, Eye, CheckCircle2, XCircle, UploadCloud, Box
} from 'lucide-react';
...
export function AugmentedReality() {
  ...
  const handleGenerateAR = async () => {
    ...
    try {
      ...
      if (!model) {
        alert('No 3D model found for this product. Please generate a 3D model first.');
        return;
      }
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-slate-600 mt-1">Create and manage AR experiences for your products</p>
      </div>

      <div className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
            <h2 className="text-xl font-bold text-slate-900 mb-4">Generate AR Asset</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 className="font-semibold text-blue-900 mb-2">AR Compatibility</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
            <h2 className="text-xl font-bold text-slate-900 mb-4">Your AR Assets</h2>

            {arAssets.length === 0 ? (
              <div className="text-center py-12">
                <Box className="w-16 h-16 text-slate-300 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-slate-900 mb-2">No AR assets yet</h3>
                <p className="text-slate-600">Generate your first AR experience above</p>
              </div>
            ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between text-xs text-slate-500 mb-3">
                        <span>{asset.file_size_mb ? `${asset.file_size_mb.toFixed(2)} MB` : 'Processing...'}</span>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm p-6 border border-slate-200">
            ...
            <div className="space-y-4 text-sm text-slate-600">
              <p>
                Augmented Reality allows your customers to visualize products in their own space before making a purchase.
              </p>

              <div className="space-y-2">
                <h3 className="font-semibold text-slate-900">Supported Formats</h3>
